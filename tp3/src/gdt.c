...
gdt_entry gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_NULL_DESC] = (gdt_entry) {
        (unsigned short)    0x0000,         /* limit[0:15]  */ //maxima cantidad de segmentos en memoria, c/segmento es de 4kb. 500MB / 1024 = 512000KB => 512000KB / 4KB/segmento = 128000 segmentos(hay que restarle 1 por algo magico del sistema (why god?)) = 127999 segmentos
        (unsigned short)    0x0000,         /* base[0:15]   */ //inicio de zona de segmentos
        ...
        (unsigned char)     0x00,           /* db           */ //segmentos de 16(0) o 32(1), usamos 1
        (unsigned char)     0x00,           /* g            */ //granularidad, 0 usa hasta 1MB, 1 hasta 4GB
